...
public class GiantEnemy : MonoBehaviour
{
    ...
    private void SplitIntoTwo()
    {
        ...
        GameObject.Instantiate(firstSplitEnemy, firstSplitEnemyPosition, Quaternion.Euler(0.0f, 0.0f, 180.0f));
        GameObject.Instantiate(secondSplitEnemy, secondSplitEnemyPosition, Quaternion.Euler(0.0f, 0.0f, 180.0f));
